...
class Property extends React.Component {
  ...
  changeStage(tabIndex) {
    this.setState({
      ...
      activeSideTabName: this.state.sideTabs[tabIndex]
    });
  }
  componentDidMount() {
    var that = this;
  ...
  render() {
    ...
    if (this.state.activeSideTabName) {
      sideStage = (
        <NewMain
          activeSideTabName={this.state.activeSideTabName}
        ...
        <div className="main-stage">
          <div className="container">
            <div className="row">
              ...
              <div className="col-sm-9">{sideStage}</div>
            </div>
          </div>
        </div>
      </div>
