			...
			<div>
				<div>
					...
					<div className="css-main-nav">
						<div className="container">
							...
							<ul className="css-login-list">
								...
								<li>
									<div
										className="css-signup-btn"
										onClick={this.showSignupPopup.bind(this)}>
										Sign Up
									</div>
								</li>
							</ul>
					...
					<div className="css-mobile-nav">
						<div className="css-mobile-nav-toggle">
						...
						<div className="container">
							<div className="row">
									...
									<form onSubmit={this.onSubmit.bind(this)}>
										<div className="css-login-inputs">
											...
											<div className="css-error-msg">
												Your Informarion Is Incorrect
											</div>
											{errors.form && (
												<div className=" alert-danger animated fadeIn">
													{errors.form}
												</div>
											)}
								...
								<div
									...
									<div className="css-main-logo-container wow animated fadeInUp">
					...
					<div className="css-footer">Copyright 2017 CommonBrain</div>
				</div>
			</div>
		);
	}
