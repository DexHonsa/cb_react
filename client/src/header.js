...
class Header extends React.Component {
	...
	render() {
		...
		if (this.state.userDropdown === true) {
			userDropdown = (
				<div className="notifications-dropdown animated-fast fadeInUp">
					<div className="caret" />
				...
				<div className="main-nav">
					<div className="container nav-container">
						...
						<div className="nav-list">
							<ul>
								<NavLink to="/product/dashboard" activeClassName="active">
									<li>Getting Started</li>
								</NavLink>
								<NavLink to="/product/my-portfolios" activeClassName="active">
									<li>My Portfolios</li>
								</NavLink>
								<NavLink to="/product/templates" activeClassName="active">
									<li>Templates</li>
								</NavLink>
							</ul>
							<ul className="login-list">
								<li>Welcome {username}</li>
								<li id="logout" onClick={this.showUserDropdown.bind(this)}>
									<i className="fa fa-user-circle-o" />
									{userDropdown}
								</li>
								<li id="alerts" onClick={this.showAlertsDropdown.bind(this)}>
