...
var newapi = require("./routes/new_routes");
...
app.route("/api/getSideTabs").post(api.GetSideTabs);
...
app.route("/api/newUpload").post(api.NewUpload);
app.route("/api/getNewUpload").post(api.GetNewUpload);
